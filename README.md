...
เพิ่ม grid 20×15 ใน `MIDDLE` ของ [src/game/chunks.ts](src/game/chunks.ts) — ทำตามกติการอยต่อในคอมเมนต์ (แถว 1 มี exit platform, แถว 13 มี entry platform, ช่องว่างกระโดดไม่เกิน 4 tiles) แล้ววาง `B` เหนือแพลตฟอร์มสำหรับจุดเกิด Mystery Box
